...
// cursor.cjs is intentionally retained as an unregistered preparation. It
// must not be exported until Windows launcher handling and rules/MCP isolation
// are verified by real capability canaries.
