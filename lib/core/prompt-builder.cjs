...
const TASK_INSTRUCTIONS = {
  ...
  tests: [
    ...
    'open network connections, load MCP/tools, or execute any other command.',
 ...
 */
function buildPrompt({ task, repoRoot, planFile, planDigest, snapshot, approvedCommands, extraInstructions } = {}) {
  assertTask(task);
