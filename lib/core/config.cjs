...
// Cursor remains an unregistered experimental adapter until its Windows
// launcher and project-rule/MCP isolation have a verified safety contract.
const STABLE_HARNESS_IDS = ['claude', 'codex', 'opencode'];
